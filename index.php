      ...
      <div class="flex items-center justify-between py-4">
        ...
        <nav>
          <ul class="flex space-x-6">
            <li class="cursor-pointer hover:text-amber-600 transition"><a herf="index.php">Home</a></li>
            ...
            <li class="cursor-pointer" herf="signIn.php"><a href="signIn.php"><svg xmlns="http://www.w3.org/2000/svg"
