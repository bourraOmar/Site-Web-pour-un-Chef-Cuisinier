        ...
        <div class="container mx-auto p-4 py-20">
            <div class="grid md:grid-cols-2 gap-8 items-center">
                <div class="text-center md:text-left">
                    ...
                    <a href="#reservation" class="inline-block bg-amber-600 text-white px-6 py-3 rounded-lg hover:bg-amber-700 transition">
                        Make A Reservation
                    </a>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8 px-[20%]">
                <div>
                    ...
                    <p class="mb-6 text-gray-700">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Deserunt quos consequatur pariatur neque dolores reiciendis fuga ullam eos tempore, ducimus commodi dignissimos. 
            ...
            <div class="grid md:grid-cols-1 gap-8 px-[20%]">
                ...
                <div>
                    <form class="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <button type="submit" 
                            class="w-full mt-4 pl-5 bg-amber-600 text-white py-3 rounded-lg hover:bg-amber-700 transition">
                            Make A Reservation
                        </button>
                    </form>
                </div>
